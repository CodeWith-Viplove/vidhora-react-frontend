              ...
              <Space direction="vertical" style={{ width: "100%" }} size="large">
                ...
                <div style={{ 
                  ...
                  <div style={{ marginBottom: '16px', position: 'relative', zIndex: 1 }}>
                    ...
                    <Divider style={{ margin: '12px 0 16px 0', borderColor: 'rgba(139, 92, 246, 0.15)' }} />
                  </div>
                  ...
                  <Row gutter={[16, 16]} justify="space-around" align="middle" style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    <Col xs={8} style={{ textAlign: 'center' }}>
                      <Progress
                        type="circle"
                        percent={bertScore ? parseFloat(bertScore) : 90}
                        size={80}
                        strokeColor={{
                          '0%': '#6366f1',
                          '100%': '#8b5cf6',
                    ...
                    <Col xs={8} style={{ textAlign: 'center', borderLeft: '1px solid #f1f5f9', borderRight: '1px solid #f1f5f9' }}>
                      <Progress
                        type="circle"
                        percent={rougeScore ? parseFloat(rougeScore) : 85}
                        size={80}
                        strokeColor={{
                          '0%': '#10b981',
                          '100%': '#059669',
                    ...
                    <Col xs={8} style={{ textAlign: 'center' }}>
                      <Progress
                        type="circle"
                        percent={hallucinationScore ? parseFloat(hallucinationScore) : 90}
                        size={80}
                        strokeColor={{
                          '0%': '#f59e0b',
                          '100%': '#ef4444',
                ...
                >
                  <div style={{ color: '#000000' }}>
                    <ReactMarkdown
                      ...
                      components={{
                        h1: ({ node, ...props }) => <h1 style={{ textAlign: 'left', color: '#000000', fontWeight: 'bold' }} {...props} />,
                        h2: ({ node, ...props }) => <h2 style={{ textAlign: 'left', color: '#000000', fontWeight: 'bold' }} {...props} />,
                        h3: ({ node, ...props }) => <h3 style={{ textAlign: 'left', marginTop: '16px', marginBottom: '4px', marginLeft: '0px', paddingLeft: '0px', color: '#000000', fontWeight: 'bold' }} {...props} />,
                        h4: ({ node, ...props }) => <h4 style={{ textAlign: 'left', color: '#000000', fontWeight: 'bold' }} {...props} />,
